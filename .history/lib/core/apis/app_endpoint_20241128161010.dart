...
class AppEndpoint {
  ...
  static String getListArtistAvailable({required String country, required String seller, required String page}) => '$artist/avails/$country?seller=$seller&page=$page&limit=10';

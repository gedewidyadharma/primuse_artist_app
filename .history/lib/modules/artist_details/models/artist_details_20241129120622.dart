...
ArtistsDetails artistsDetailsFromJson(String str) => ArtistsDetails.fromJson(json.decode(str));

String artistsDetailsToJson(ArtistsDetails data) => json.encode(data.toJson());
...
class ArtistsDetails {
    ...
    factory ArtistsDetails.fromJson(Map<String, dynamic> json) => ArtistsDetails(
        id: json["id"],
        active: json["active"],
        name: json["name"],
...
class PlatformClass {
    ...
    factory PlatformClass.fromJson(Map<String, dynamic> json) => PlatformClass(
        id: json["id"],
        url: json["url"],
        platform: platformEnumValues.map[json["platform"]]!,
    );

    Map<String, dynamic> toJson() => {
        "id": id,
        "url": url,
        "platform": platformEnumValues.reverse[platform],
    };
}
...
final platformEnumValues = EnumValues({
    "primuse": PlatformEnum.PRIMUSE,
    "songtats": PlatformEnum.SONGTATS,
    "viberate": PlatformEnum.VIBERATE
});

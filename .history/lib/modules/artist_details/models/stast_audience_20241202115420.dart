...
class MonthlyListener {
    ...
    factory MonthlyListener.fromJson(Map<String, dynamic> json) => MonthlyListener(
        ...
        peakDate: json["peak_date"] == null ? null : DateTime.parse(json["peak_date"]),
        cityRegion: json["city_region"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "peak_date": "${peakDate!.year.toString().padLeft(4, '0')}-${peakDate!.month.toString().padLeft(2, '0')}-${peakDate!.day.toString().padLeft(2, '0')}",
        "city_region": cityRegion,
        "city_lat": cityLat,
        "city_lng": cityLng,
        "country": country?.toJson(),

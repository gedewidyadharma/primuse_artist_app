   ...
   PreferredSizeWidget _buildAppBar() {
    return PreferredSize(
      ...
      child: Obx(() => AnimatedContainer(
        ...
        color: controller.showAppBar.value 
            ? Colors.white 
            : Colors.transparent,
        child: AppBar(
          elevation: 0,
...
class _Body extends GetView<ArtistDetailsController> {
  ...
  _Body() {
    ...
    _scrollController.addListener(() {
      // Ambil posisi scroll
      final showAppBar = _scrollController.hasClients && 
          _scrollController.offset > (Get.width - kToolbarHeight);
      
      // Update state di controller

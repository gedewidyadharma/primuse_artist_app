...
class _PlatformDistributionView extends GetView<ArtistDetailsController> {
  @override
  Widget build(BuildContext context) {
    return Obx(
      () =>  Column(
        ...
        children: [
          Container(
            ...
            child: controller.dataStreamingPlatform.value.isEmpty ? const PlatformDistributionShimmer() : SfCircularChart(

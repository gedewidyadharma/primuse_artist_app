      ...
      () =>  Column(
        ...
        children: [
          Container(
            ...
            child: controller.dataStreamingPlatform.value.isEmpty ? const ChartShimmer() : SfCircularChart(
           ...
           controller.dataStreamingPlatform.value.isEmpty ? const StatsGridShimmer() : GridView.builder(

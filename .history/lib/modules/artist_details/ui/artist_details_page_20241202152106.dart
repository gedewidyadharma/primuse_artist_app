            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                columns: [
                  ...
                  DataColumn(label: Text('City',style: Theme.of(context).textTheme.labelLarge,)),
                  DataColumn(label: Text('Current',style: Theme.of(context).textTheme.labelLarge,)),
                  DataColumn(label: Text('Peak', style: Theme.of(context).textTheme.labelLarge,)),
                  DataColumn(label: Text('Peak Date', style: Theme.of(context).textTheme.labelLarge,)),

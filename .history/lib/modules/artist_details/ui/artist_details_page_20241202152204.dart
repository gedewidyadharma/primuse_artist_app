        ...
        child: Column(
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                columns: [
                  DataColumn(label: Text('#', style: Theme.of(context).textTheme.labelMedium!.copyWith(fontWeight: FontWeight.w600),)),
                  DataColumn(label: Text('City',style: Theme.of(context).textTheme.labelMedium!.copyWith(fontWeight: FontWeight.w600),)),
                  DataColumn(label: Text('Current',style: Theme.of(context).textTheme.labelMedium!.copyWith(fontWeight: FontWeight.w600),)),
                  DataColumn(label: Text('Peak', style: Theme.of(context).textTheme.labelMedium!.copyWith(fontWeight: FontWeight.w600),)),
                  DataColumn(label: Text('Peak Date', style: Theme.of(context).textTheme.labelMedium!.copyWith(fontWeight: FontWeight.w600),)),
                ...
                rows: List.generate(
                  ...
                  (index) {
                    ...
                    cells: [
                      ...
                      DataCell(Text("${data.country?.flag?.emoji ?? ""}   ${data.cityName ?? ""}", style: Theme.of(context).textTheme.labelMedium,)),
                      DataCell(Text(NumberFormating.formatNumberSeparator(data.currentListeners ?? 0), style: Theme.of(context).textTheme.labelMedium,)),
                      DataCell(Text(NumberFormating.formatNumberSeparator(data.peakListeners ?? 0), style: Theme.of(context).textTheme.labelMedium,)),
                      DataCell(Text(DateFormating.changeFormatFromString(format: "dd-MMM-yyyy", date: data.peakDate ?? ""), style: Theme.of(context).textTheme.labelMedium,)),

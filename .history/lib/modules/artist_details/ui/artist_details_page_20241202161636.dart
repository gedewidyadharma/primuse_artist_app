            ...
            series: <LineSeries<ChartData, String>>[
              LineSeries<ChartData, String>(
                ...
                dataSource:  <ChartData>[
                  ChartData(category: 'Jan', value: 35),
                  ChartData(category:'Feb',  value: 28),
                  ChartData(category:'Mar',  value: 34),
                  ChartData(category:'Apr', value: 32),
                  ChartData(category:'May', value: 40)
                ],
                xValueMapper: (ChartData sales, _) => "200",
                yValueMapper: (ChartData sales, _) => 20
              )
            ]
    );
  }

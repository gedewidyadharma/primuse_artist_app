    ...
    return Obx(
      () => SfCartesianChart(
        ...
        zoomPanBehavior: ZoomPanBehavior(
          // Enable panning
          enablePanning: true,
          // Optional: disable pinch zoom jika hanya ingin scroll
          enablePinching: false,
          // Optional: Set zoom mode ke X axis saja
          zoomMode: ZoomMode.x,
        ),
        series: <SplineSeries<History, String>>[
          SplineSeries<History, String>(
            // Bind data source
            dataSource: controller.dataHistorySpotify.value,
            xValueMapper: (History sales, _) => sales.date,
            yValueMapper: (History sales, _) => sales.value,
          )
        ],
      ),
    );

      ...
      () => SfSparkLineChart.custom(
        ...
        // ],
            ...
            //Enable the trackball
                ...
                xValueMapper: (int index) => controller.dataHistorySpotify[index].date,
                yValueMapper: (int index) => controller.dataHistorySpotify[index].monthlyListenersCurrent ?? 0,
                dataCount: controller.dataHistorySpotify.length,
      ),
    );
  }
}

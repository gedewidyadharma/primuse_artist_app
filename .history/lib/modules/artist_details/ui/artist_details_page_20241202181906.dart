    ...
    return Obx(
      () => SfCartesianChart(
        ...
        primaryYAxis: NumericAxis(
          numberFormat: NumberFormat.compact(), // Ini akan otomatis convert ke K, M, B
          // Atau gunakan custom label formatter
          axisLabelFormatter: (AxisLabelRenderDetails args) {
            double value = double.parse(args.text);
            if (value >= 1000000) {
              return ChartAxisLabel('${(value / 1000000).toStringAsFixed(1)}M', args.textStyle.copyWith(color: Colors.black87));
            } else if (value >= 1000) {
              return ChartAxisLabel('${(value / 1000).toStringAsFixed(1)}K', args.textStyle.copyWith(color: Colors.black87));
            }
            return ChartAxisLabel(value.toStringAsFixed(0), args.textStyle.copyWith(color: Colors.black87));
          },
        ),

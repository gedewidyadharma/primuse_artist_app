  ...
  Widget build(BuildContext context) {
    return Obx(
      () => SfCartesianChart(
        ...
        //     if (value >= 1000000) {
        //       return ChartAxisLabel('${(value / 1000000).toStringAsFixed(1)}M', args.textStyle);
        //     } else if (value >= 1000) {
        //       return ChartAxisLabel('${(value / 1000).toStringAsFixed(1)}K', args.textStyle);
        //     }
        //     return ChartAxisLabel(value.toStringAsFixed(0), args.textStyle);
        //   },
        ),

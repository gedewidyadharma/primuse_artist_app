            ...
            child: Column(
              ...
              children: [
                _LabelValue(
                  ...
                  value: "${DateFormating.changeFormatFromString(format: "MMM DD, yyyy", date: artist.dates?.from ?? "")}",
                ),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(value, style: Theme.of(context).textTheme.labelLarge!.copyWith(fontSize: 14)),
      ],
    );
  }
}
